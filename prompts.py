...
EXTRACT_EVIDENCE_SINGLE_SYSTEM = (
    ...
    "3. INCLUDE SURROUNDING CONTEXT: If the answer appears under a header or section title, INCLUDE that header in your quote.\n"
    "   Example: If extracting '- Budget: $1.5M', also include 'Phase 1:' header if it appears immediately before.\n"
    "4. PREFER LARGER CONTIGUOUS BLOCKS. Extract complete sections with their headers, not just isolated bullet points.\n"
    "5. If the answer is NOT strictly present in the text, return status: NO_EVIDENCE.\n"
